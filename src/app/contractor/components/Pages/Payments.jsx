...
import { IndianRupee, Calendar, CheckCircle, Clock, AlertCircle, ChevronDown, ChevronRight, Eye, Wallet, TrendingUp, Users, BarChart3 } from "lucide-react";
...
export default function PaymentsPage() {
	...
	const fetchContractorPayments = async () => {
		try {
			...
			console.log("FETCHING PAYMENTS WITH TOKEN:", token ? "exists" : "missing");
			...
			if (data.success) {
				...
				console.log("PAYMENTS STATE UPDATED:", data.payments.length);
	...
	console.log("GROUPED PAYMENTS:", Object.keys(groupedPayments));
	console.log("RAW PAYMENTS ARRAY:", payments);
